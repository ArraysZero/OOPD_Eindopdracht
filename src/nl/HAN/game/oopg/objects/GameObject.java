package nl.HAN.game.oopg.objects;

import nl.HAN.game.oopg.userinput.IKeyInput;
import nl.HAN.game.oopg.userinput.IMouseInput;
...
public abstract class GameObject implements IKeyInput, IMouseInput, PConstants {
    ...
    /*
     * (non-Javadoc)
     * @see nl.han.ica.oopg.userinput.IKeyInput#keyPressed(int, char)
     */
    ...
    /*
     * (non-Javadoc)
     * @see nl.han.ica.oopg.userinput.IKeyInput#keyReleased(int, char)
     */
    ...
    /*
     * (non-Javadoc)
     * @see nl.han.ica.oopg.userinput.IMouseInput#mousePressed(int, int)
     */
    ...
    /*
     * (non-Javadoc)
     * @see nl.han.ica.oopg.userinput.IMouseInput#mouseReleased(int, int)
     */
    ...
    /*
     * (non-Javadoc)
     * @see nl.han.ica.oopg.userinput.IMouseInput#mouseClicked(int, int)
     */
    ...
    /*
     * (non-Javadoc)
     * @see nl.han.ica.oopg.userinput.IMouseInput#mouseMoved(int, int)
     */
    ...
    /*
     * (non-Javadoc)
     * @see nl.han.ica.oopg.userinput.IMouseInput#mouseDragged(int, int)
     */
    ...
    /*
     * (non-Javadoc)
     * @see nl.han.ica.oopg.userinput.IMouseInput#mouseWheel(int)
     */
